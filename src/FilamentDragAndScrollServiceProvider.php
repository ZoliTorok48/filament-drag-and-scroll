...
class FilamentDragAndScrollServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        FilamentAsset::register([
            Css::make('filament-drag-and-scroll-core-styles', __DIR__ . "/../resources/{$cssPath}/filament-drag-and-scroll{$cssExt}"),
            Js::make('filament-drag-and-scroll-core-scripts', __DIR__ . "/../resources/{$jsPath}/filament-drag-and-scroll{$jsExt}"),
        ], package: static::$name);
